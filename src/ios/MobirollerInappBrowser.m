...
#import "MobirollerInAppBrowser.h"
...
#pragma mark MobirollerInAppBrowser

@interface MobirollerInAppBrowser () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation MobirollerInAppBrowser
...
{
    MobirollerInAppBrowserOptions* browserOptions = [MobirollerInAppBrowserOptions parseOptions:options];
    ...
    if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[MobirollerInAppBrowserViewController alloc] initWithUserAgent:originalUA prevUserAgent:[self.commandDelegate userAgent] browserOptions: browserOptions];
        self.inAppBrowserViewController.navigationDelegate = self;

        if ([self.viewController conformsToProtocol:@protocol(CDVScreenOrientationDelegate)]) {
            self.inAppBrowserViewController.orientationDelegate = (UIViewController <CDVScreenOrientationDelegate>*)self.viewController;
        }
        CGRect inAppBrowserRect = self.inAppBrowserViewController.view.frame;
        if(browserOptions.hastabs) {
            inAppBrowserRect.size.height = inAppBrowserRect.size.height - 48;
        }
        inAppBrowserRect.origin.y = 64;
        self.inAppBrowserViewController.view.frame = inAppBrowserRect;
    }
    ...
    self.inAppBrowserViewController.modalPresentationStyle = UIModalPresentationOverCurrentContext;//presentationStyle;
...
- (void)show:(CDVInvokedUrlCommand*)command
{
    ...
    MobirollerInAppBrowserNavigationController* nav = [[MobirollerInAppBrowserNavigationController alloc]
...
@implementation MobirollerInAppBrowserViewController

@synthesize currentURL;

- (id)initWithUserAgent:(NSString*)userAgent prevUserAgent:(NSString*)prevUserAgent browserOptions: (MobirollerInAppBrowserOptions*) browserOptions
{
    self = [super init];
    if (self != nil) {
...
@implementation MobirollerInAppBrowserOptions
...
+ (MobirollerInAppBrowserOptions*)parseOptions:(NSString*)options
{
    MobirollerInAppBrowserOptions* obj = [[MobirollerInAppBrowserOptions alloc] init];
...
@implementation MobirollerInAppBrowserNavigationController : UINavigationController
